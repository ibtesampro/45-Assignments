...
var seeingtheworld = ["Russia", "NewYork", "Honolulu", "Turkey", "England"];
...
console.log(__spreadArray([], seeingtheworld, true).sort(), "I have changed the array to alphabetical order without modifying the actual list.");
//The first array is in original order
console.log(seeingtheworld, "The first array is still is in it's ariginal order.");
//Printing the array in reverse order
console.log(__spreadArray([], seeingtheworld, true).reverse(), "The array is printed in reverse order.");
//The first array is in original order
console.log(seeingtheworld, "The first array is still is in it's ariginal order.");
